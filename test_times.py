...
@pytest.mark.parametrize("time_range1,time_range2,expected", [
    ...
    (time_range("2022-01-01 10:00:00", "2022-01-01 11:00:00"),
     time_range("2022-01-01 12:00:00", "2022-01-01 13:00:00"), 
     []),
     (time_range("2022-01-01 10:00:00", "2022-01-01 12:00:00", 2,0),
     time_range("2022-01-01 11:00:00", "2022-01-01 13:00:00", 2,0), 
     [('2022-01-01 11:00:00', '2022-01-01 12:00:00')]),
     (time_range("2022-01-01 10:00:00", "2022-01-01 11:00:00"),
     time_range("2022-01-01 11:00:00", "2022-01-01 12:00:00"), 
     []),
        ])
